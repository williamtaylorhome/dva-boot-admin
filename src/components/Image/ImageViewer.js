...
const mousewheelEventName = "onwheel" in document.createElement("div") ? "wheel" : // High-version browsers from various manufacturers support "wheel"
  document.onmousewheel !== undefined ? "mousewheel" : // Webkit and IE must be supported "mousewheel"
    "DOMMouseScroll";
