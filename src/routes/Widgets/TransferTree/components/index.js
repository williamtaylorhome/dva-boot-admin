...
export default class extends BaseComponent {
  ...
  onCustomChange = (targetKeys, targetNodes, e) => {
    if (e === 'OutOfMaxSize') {
      this.notice.warn("You can only choose up to 2 people!");
    }
  };
    ...
    return (
      <Layout className="full-layout page transfer-tree-page">
        <Content>
          <Row gutter={20}>
            <Col span={12}>
              <Panel title="Tree type shrink frame">
                <TransferTree dataSource={dataSource} loading={loading} />
              </Panel>
            </Col>
            <Col span={12}>
              <Panel title="Asynchronous tree shrinkage frame">
                <TransferTree
          ...
          <Row gutter={20}>
            <Col span={12}>
              <Panel title="Default value targetNodes">
                <TransferTree
            ...
            <Col span={12}>
              <Panel title="MAX & ICON">
                <TransferTree
                  className="my-theme"
                  titleText="Organizational structure"
